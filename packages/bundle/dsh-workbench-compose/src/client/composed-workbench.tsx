...
import { FileDocumentPanel, useFileTree } from '@yeisme/dsh-file-document/client'
import type { FileEntryV1, FileTreeHostAdapter } from '@yeisme/dsh-file-document/client'
