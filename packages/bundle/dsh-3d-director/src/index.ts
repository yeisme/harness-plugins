  ...
  model: {
    services: [{
      ...
      members: [
        ...
        { kind: 'method', name: 'sceneWorkbenchRead', signature: 'sceneWorkbenchRead(input: unknown): Promise<SceneWorkbenchReadResult>' },
        { kind: 'method', name: 'saveScene', signature: 'saveScene(input: unknown): Promise<SceneGraphSaveResult>' },
        { kind: 'method', name: 'saveSceneWorkbench', signature: 'saveSceneWorkbench(input: unknown): Promise<SceneGraphSaveResult>' },
        ...
        { kind: 'method', name: 'previewChangeSet', signature: 'previewChangeSet(input: unknown): Promise<Scene3DChangeSetPreviewResultV1>' },
        { kind: 'method', name: 'acceptChangeSet', signature: 'acceptChangeSet(input: unknown): Promise<Scene3DChangeSetTransitionResultV1>' },
        { kind: 'method', name: 'rejectChangeSet', signature: 'rejectChangeSet(input: unknown): Promise<Scene3DChangeSetTransitionResultV1>' },
        { kind: 'method', name: 'rollbackChangeSet', signature: 'rollbackChangeSet(input: unknown): Promise<Scene3DChangeSetRollbackResultV1>' },
      ],
      types: [],
    }],
    events: [],
