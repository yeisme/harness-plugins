...
export {
  ...
  SonoraWorksTableClient,
  SonoraWorkspaceClient,
  SonoraCapabilityMatrixClient,
  SonoraAuditionClient,
  SonoraSubtitleHandoffClient,
...
export type {
  ...
  SonoraAudioStudioExtras,
  SonoraWorksTableResult,
  SonoraWorkspaceBoard,
  SonoraWorkspaceActionDescriptor,
  SonoraWorkspaceActionReceipt,
  SonoraSubtitleHandoff,
  SonoraSubtitleHandoffResult,
  SonoraAudioJob,
  SonoraAudioAsset,
...
const creatorStudioTypertContribution = {
  ...
  model: {
    services: [{
      ...
      members: [
        ...
        { kind: 'method', name: 'readWorksTable', signature: 'readWorksTable(input?: unknown): Promise<SonoraWorksTableResult | { status: "rejected"; reason: "invalid_input" } | null>' },
        { kind: 'method', name: 'readCapabilityMatrix', signature: 'readCapabilityMatrix(): Promise<SonoraCapabilityMatrix | null>' },
  ...
  invocations: [
    ...
    { id: '@yeisme/dsh-creator-studio-host#creatorStudio/readWorksTable', service: 'creatorStudio', namespace: 'creatorStudio', method: 'readWorksTable',
      invocation: { kind: 'direct' }, parameters: [{ name: 'input', wire: 'input', source: 'json', codec: { mode: 'src-json' } }], result: { mode: 'src-json' } },
    { id: '@yeisme/dsh-creator-studio-host#creatorStudio/readCapabilityMatrix', service: 'creatorStudio', namespace: 'creatorStudio', method: 'readCapabilityMatrix',
