...
const commands = [
  ...
  ['pnpm', ['--filter', '@yeisme/dsh-client-ui-desktop-workbench', 'exec', 'vitest', 'run', 'tests/file-open-pane.spec.tsx']],
]
...
writeFileSync(resolve(evidenceDir, 'artifacts', 'contract.txt'), 'opaque-ref -> language host -> semantic API -> desktop.file fallback\n')
