 ...
 * (dsh-template-registry-integration-v1, task 1.2).
 *
 ...
 * This module is contract-only: no transport, no host wiring, no storage I/O.
 ...
 * and shape; 1.2 only adds fields (all defaulted/optional) and new exports.
 *
