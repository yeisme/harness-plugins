...
const command = 'pnpm --filter @yeisme/dsh-client-ui-desktop-workbench exec vitest run tests/git-pane.spec.tsx --config vitest.config.ts'
...
const result = spawnSync('pnpm', [
  '--filter', '@yeisme/dsh-client-ui-desktop-workbench',
  'exec', 'vitest', 'run', 'tests/git-pane.spec.tsx', '--config', 'vitest.config.ts',
