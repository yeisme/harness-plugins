...
@media(max-width:600px){.pwr-root[data-region='right'] .pwr-picker{top:52px;right:6px;width:min(340px,calc(100vw - 48px))}.pwr-menu{right:4px;width:min(232px,calc(100vw - 16px))}.pwr-management-center{width:calc(100vw - 16px);max-height:calc(100vh - 16px)}.pwr-management-scope{display:none}.pwr-management-footer{flex-wrap:wrap}}
