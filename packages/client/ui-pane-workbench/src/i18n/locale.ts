...
const EN_BUNDLE: LocaleBundle = {
  ...
  resources: {
    ...
    'management.search.clear': 'Clear search',
    'management.search.shortcut': 'Search shortcut',
    'management.search.loadingConversation': 'Searching conversation content…',
    'management.search.loadingWorkspace': 'Searching authorized workspaces…',
    'management.search.partial': 'Some results may be unavailable.',
    'management.search.retry': 'Retry search',
    'management.search.reason.permission_denied': 'You do not have permission to search this source.',
    'management.search.reason.contract_mismatch': 'This search source is incompatible with the current host.',
    'management.search.reason.offline': 'This search source is offline.',
    'management.search.reason.failed': 'Search failed. Try again.',
    'management.similar.title': 'You might be looking for',
    'management.includeConversation': 'Search conversations',
    ...
    'management.filter.activeCount': '{count} active',
    'management.filter.reset': 'Reset filters',
    'management.filter.label.group': 'Group',
    'management.filter.label.region': 'Region',
    'management.filter.label.owner': 'Owner',
    'management.filter.label.type': 'Type',
    'management.filter.label.status': 'Status',
    'management.filter.label.pinned': 'Pinned',
    'management.filter.label.workspace': 'Workspace',
    ...
    'management.targetFor': 'Choose open target for {title}',
    'management.source.all': 'All',
    ...
    'management.selectedCount': '{count} selected',
    ...
    'state.orphaned': 'Unavailable',
    'state.closed': 'Closed',
    'state.running': 'Running',
    'state.permission_denied': 'Permission denied',
    'state.contract_mismatch': 'Contract mismatch',
    ...
    // Workspace Designer
    'designer.selection.title': 'Selection & Interaction',
    'designer.selection.description': 'Per-context action visibility, order, shortcut, density and preset. Only bounded canonical action ids and UI values are stored.',
    'designer.selection.contexts': 'Selection contexts',
    'designer.selection.context.text': 'Text',
    'designer.selection.context.source': 'Source',
    'designer.selection.context.image-region': 'Image region',
    'designer.selection.context.table-range': 'Table range',
    'designer.selection.context.editable-control': 'Editable control',
    'designer.selection.visibility': 'Action visibility',
    'designer.selection.order': 'Action order',
    'designer.selection.shortcut': 'Actions shortcut',
    'designer.selection.density': 'Density',
    'designer.selection.preset': 'Preset',
    ...
    'capabilities.unifiedHost': 'Unified host · split, float and dock',
    ...
    'search.category.pane': 'Panes',
    'search.category.command': 'Commands',
    'search.filter.opened': 'Open',
    'search.filter.allProjects': 'All accessible projects',
    'search.filter.time': 'Time filter',
    'search.clearFilters': 'Clear filters',
    'search.saveFilter': 'Save filter',
    'search.namedFilters': 'Saved filters',
    'search.staleProject': 'That saved filter points at a project that is no longer accessible. The scope was not widened.',
    'search.clearRecent': 'Clear recent',
    'search.empty': 'No matching results.',
    'search.emptyFiltered': 'No results match the current filters. Clear filters to broaden the search.',
    'search.emptyHistory': 'No matching history in this scope.',
    'search.loading': 'Updating history…',
    'search.partial': 'Some history is still loading.',
    'search.stale': 'Showing cached history while it updates.',
    'search.slow': 'History is taking longer than usual. You can keep using local results.',
    'search.historyUnavailable': 'History search is unavailable in this host.',
    'search.timeUnavailable': 'This source cannot apply a time filter to the full history.',
    'search.openFailed': 'Could not open that result. The search stays open.',
    'search.storageFailed': 'Preferences were not saved. Search still works.',
    'search.count.found': 'Found {count}',
    'search.count.exact': '{count}',
    'search.group.recent': 'Recent',
    'search.group.opened': 'Open',
    'search.group.frequent': 'Frequent tools',
    'search.group.session': 'Sessions',
    'search.group.pane': 'Panes',
    'search.group.command': 'Commands',
    'search.group.compatibility': 'Compatibility and advanced',
    'search.compatibilityHint': 'Hidden unless you search the exact name or ID',
    'search.actionsFor': 'Open actions for {title}',
    'search.openRight': 'Open to the right',
    'search.openBelow': 'Open below',
    'search.openFloat': 'Open floating',
    'search.run': 'Run',
  }
}
...
const ZH_BUNDLE: LocaleBundle = {
  ...
  resources: {
    ...
    'management.search.clear': '清除搜索',
    'management.search.shortcut': '搜索快捷键',
    'management.search.loadingConversation': '正在搜索对话内容…',
    'management.search.loadingWorkspace': '正在搜索已授权工作区…',
    'management.search.partial': '部分结果可能暂不可用。',
    'management.search.retry': '重试搜索',
    'management.search.reason.permission_denied': '你没有权限搜索此来源。',
    'management.search.reason.contract_mismatch': '此搜索来源与当前宿主不兼容。',
    'management.search.reason.offline': '此搜索来源当前离线。',
    'management.search.reason.failed': '搜索失败，请重试。',
    'management.similar.title': '你可能在找',
    'management.includeConversation': '搜索对话',
    ...
    'management.filter.activeCount': '已启用 {count} 项',
    'management.filter.reset': '重置筛选',
    'management.filter.label.group': '分组',
    'management.filter.label.region': '区域',
    'management.filter.label.owner': '所有者',
    'management.filter.label.type': '类型',
    'management.filter.label.status': '状态',
    'management.filter.label.pinned': '固定',
    'management.filter.label.workspace': '工作区',
    'management.filter.group': '全部分组',
    'management.filter.region': '右侧 / 底部',
    'management.filter.owner': '全部所有者',
    ...
    'management.targetFor': '选择“{title}”的打开位置',
    'management.source.all': '全部',
    'management.source.pane': '可用窗格',
    'management.source.tab': '已打开标签页',
    ...
    'management.selectedCount': '已选择 {count} 项',
    ...
    'state.closed': '已关闭',
    'state.running': '运行中',
    'state.permission_denied': '权限被拒绝',
    'state.contract_mismatch': '合同不兼容',
    'state.offline': '离线',
    'state.stale': '内容可能已过期',
    ...
    // Workspace Designer
    'designer.selection.title': '选区与交互',
    'designer.selection.description': '按上下文配置动作可见性、顺序、快捷键、密度与 preset；只保存有界 canonical action id 与 UI 值。',
    'designer.selection.contexts': '选区上下文',
    'designer.selection.context.text': '文本',
    'designer.selection.context.source': '源码',
    'designer.selection.context.image-region': '图片区域',
    'designer.selection.context.table-range': '表格范围',
    'designer.selection.context.editable-control': '编辑控件',
    'designer.selection.visibility': '动作可见性',
    'designer.selection.order': '动作顺序',
    'designer.selection.shortcut': 'Actions 快捷键',
    'designer.selection.density': '密度',
    'designer.selection.preset': 'Preset',
    ...
    'capabilities.unifiedHost': '宿主工作台 · 分屏、悬浮与停靠',
    ...
    'search.category.pane': '窗格',
    'search.category.command': '命令',
    'search.filter.opened': '已打开',
    'search.filter.allProjects': '所有可访问项目',
    'search.filter.time': '时间筛选',
    'search.clearFilters': '清除筛选',
    'search.saveFilter': '保存筛选',
    'search.namedFilters': '常用筛选',
    'search.staleProject': '该常用筛选指向已不可访问的项目，范围没有被扩大。',
    'search.clearRecent': '清空最近',
    'search.empty': '没有匹配结果。',
    'search.emptyFiltered': '当前筛选没有结果。清除筛选可扩大范围。',
    'search.emptyHistory': '当前范围没有匹配的历史。',
    'search.loading': '正在更新历史…',
    'search.partial': '部分历史仍在加载。',
    'search.stale': '正在显示缓存历史并在后台更新。',
    'search.slow': '历史来源较慢，本地结果仍可使用。',
    'search.historyUnavailable': '当前宿主不支持历史搜索。',
    'search.timeUnavailable': '此来源无法对全部历史应用时间筛选。',
    'search.openFailed': '无法打开该结果，搜索仍保持打开。',
    'search.storageFailed': '偏好未保存，搜索仍可用。',
    'search.count.found': '已找到 {count} 项',
    'search.count.exact': '{count}',
    'search.group.recent': '最近使用',
    'search.group.opened': '已打开',
    'search.group.frequent': '常用工具',
    'search.group.session': '会话',
    'search.group.pane': '窗格',
    'search.group.command': '命令',
    'search.group.compatibility': '兼容与高级',
    'search.compatibilityHint': '默认折叠，精确名称或 ID 仍可发现',
    'search.actionsFor': '“{title}”的打开方式',
    'search.openRight': '在右侧打开',
    'search.openBelow': '在下方打开',
    'search.openFloat': '悬浮打开',
    'search.run': '执行',
  }
}
