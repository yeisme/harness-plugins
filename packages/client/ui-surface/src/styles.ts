...
const surfaceExtra = `
${S}.ys-surface{container:yeisme-surface/inline-size;display:flex;flex-direction:column;width:100%;min-width:0;min-height:100%;overflow:hidden;background:var(--vk-bg-base);color:var(--vk-text-primary);font-family:inherit;font-size:var(--vk-font-body);line-height:1.5}
${S} .ys-context-bar{position:sticky;top:0;z-index:3;display:grid;grid-template-columns:minmax(0,1fr) auto auto;grid-template-areas:'copy status actions' 'nav nav nav';align-items:center;gap:6px 8px;min-width:0;padding:8px 10px;background:color-mix(in srgb,var(--vk-bg-layer-1) 96%,transparent);border-bottom:1px solid var(--vk-border-l2);backdrop-filter:blur(12px)}
${S} .ys-context-copy{grid-area:copy;display:flex;align-items:baseline;flex-wrap:wrap;gap:2px 8px;min-width:0}
...
${S} .ys-context-description{flex:1 0 100%;overflow:hidden;color:var(--vk-text-tertiary);font-size:var(--vk-font-small);text-overflow:ellipsis;white-space:nowrap}
...
${S} .ys-context-nav{grid-area:nav;display:flex;align-items:center;gap:4px;min-width:0;padding-top:5px;overflow-x:auto;border-top:1px solid var(--vk-border-l1);scrollbar-width:thin}
${S} .ys-body{display:grid;align-content:start;gap:12px;min-width:0;min-height:0;padding:12px;overflow:auto}
${S} .ys-section{display:grid;gap:8px;min-width:0}
...
${S} .ys-state{display:grid;place-items:center;align-content:center;gap:6px;min-width:0;min-height:92px;padding:16px;text-align:center;color:var(--vk-text-tertiary);border:1px solid var(--vk-border-l1);border-radius:var(--vk-radius-md);background:color-mix(in srgb,var(--vk-bg-layer-1) 72%,transparent)}
${S} .ys-state[data-phase='stale'],${S} .ys-state[data-phase='partial'],${S} .ys-state[data-phase='error'],${S} .ys-state[data-phase='success']{place-items:start;align-content:start;gap:3px;min-height:0;padding:10px 12px;text-align:left}
${S} .ys-state[data-phase='stale'],${S} .ys-state[data-phase='partial']{color:var(--vk-text-secondary);border-color:color-mix(in srgb,var(--vk-tone-warn) 28%,var(--vk-border-l1));background:color-mix(in srgb,var(--vk-tone-warn) 6%,var(--vk-bg-layer-1))}
${S} .ys-state[data-phase='error']{color:var(--vk-text-secondary);border-color:color-mix(in srgb,var(--vk-tone-critical) 30%,var(--vk-border-l1));background:color-mix(in srgb,var(--vk-tone-critical) 6%,var(--vk-bg-layer-1))}
${S} .ys-state[data-phase='success']{color:var(--vk-text-secondary);border-color:color-mix(in srgb,var(--vk-tone-positive) 26%,var(--vk-border-l1));background:color-mix(in srgb,var(--vk-tone-positive) 5%,var(--vk-bg-layer-1))}
${S} .ys-state-title{margin:0;color:var(--vk-text-primary);font-size:var(--vk-font-strong);font-weight:650}
${S} .ys-state-description{max-width:64ch;margin:0;color:var(--vk-text-tertiary);font-size:var(--vk-font-small);line-height:1.45}
${S} .ys-state-action{display:flex;align-items:center;justify-content:center;gap:6px;margin-top:2px}
${S} .ys-state[data-phase='stale'] .ys-state-action,${S} .ys-state[data-phase='partial'] .ys-state-action,${S} .ys-state[data-phase='error'] .ys-state-action,${S} .ys-state[data-phase='success'] .ys-state-action{justify-content:flex-start}
...
${S} .ys-field>input,${S} .ys-field>select,${S} .ys-field>textarea{box-sizing:border-box;width:100%;min-height:var(--vk-ctrl-input);padding:7px 9px;color:var(--vk-text-primary);background:var(--vk-bg-layer-2);border:1px solid var(--vk-border-l2);border-radius:var(--vk-radius-md);font:inherit}
...
@container yeisme-surface (max-width:420px){
  ${S} .ys-context-bar{position:relative;grid-template-columns:minmax(0,1fr);grid-template-areas:'copy' 'status' 'actions' 'nav';padding:8px 10px}
