...
export interface DevtoolsToolRecordV1 extends Base { readonly type: 'tool'; readonly kind: 'skill' | 'mcp'; readonly name: string; readonly loadStatus: 'loaded' | 'unavailable' | 'stale' | 'unknown'; readonly callStatus: 'idle' | 'success' | 'error' | 'partial'; readonly callCount: number; readonly durationMs?: number; readonly source?: string; readonly version?: string; readonly schemaSummary?: string; readonly errorSummary?: string; readonly traceRef?: string }
export type DevtoolsRecordV1 = DevtoolsLogRecordV1 | DevtoolsSpanRecordV1 | DevtoolsSampleRecordV1 | DevtoolsFindingRecordV1 | DevtoolsLifecycleRecordV1 | DevtoolsToolRecordV1
