...
const node = {
  ...
  target: 'es2024',
  dts: true,
  // tsc emits lib/types first; keep them instead of cleaning the outDir.
  clean: false,
...
export default defineConfig([
  { ...node, entry: ['./src/index.ts'] },
  {
    ...
    outputOptions: {
      ...
      banner: 'window.__ModuleLoader__.load({ id: "@yeisme/dsh-client-ui-personal-radar", factory: (require) => {',
