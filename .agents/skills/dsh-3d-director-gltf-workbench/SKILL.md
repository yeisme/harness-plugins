...
description: Design and implement the DSH 3D Director workbench with Shot anchored scene orchestration, Khronos glTF/GLB contracts, canvas/viewport synchronization, auditable generation change sets, and revision-safe conflict handling.
---
