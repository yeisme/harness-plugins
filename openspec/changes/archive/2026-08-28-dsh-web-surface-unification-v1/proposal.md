...
- 按四波迁移全部 React/Web 表面：基础层、工作台与工具面、创作与 Agent workspace、dialog/overlay/微表面。
...
- 采纳面：`packages/client/ui-*` 的全部 React/Web surface，以及 bundle 内自有的 file/document、rich-media、terminal、workbench composition Web UI。
