...
- [ ] 3.1 L2 seam `upstream-prs/mcp-inventory/`：patch + apply.sh + 推 fork pr 分支（用户已确认留待专门会话；设计见 design.md）。 Recheck 2026-09-04: `[external-gate skipped]` 维持——用户已确认留待专门会话；`upstream-prs/mcp-inventory/` 仍未创建（上游全树 mcp-inventory 0 命中）。 Recheck 2026-09-06: `[external-gate skipped]` 维持——用户已确认留待专门会话；上游 HEAD `d347e70390` 全树 mcp-inventory 0 命中，`upstream-prs/mcp-inventory/` 仍未创建。 Recheck 2026-09-07: `[external-gate skipped]` 维持——用户已确认 `upstream-prs/mcp-inventory/` 留待专门会话；上游 0.1.3-alpha.2 五包 tarball mcp-inventory 0 命中，L2 seam 仍未创建。 Recheck 2026-09-09: `[external-gate skipped]` 维持——上游 alpha 前移至 0.1.5-alpha.1（dsh-agent/dsh-session/dsh-web/dsh-fs 四包 tarball 全量 grep mcp-inventory 0 命中）、next 仍 0.1.2-rc.1 无新 seam 发布。
  - 2026-09-03 [external-gate skipped] 复核：`upstream-prs/mcp-inventory/` 仍未创建；用户已确认留待专门会话处理（设计见 design.md），本仓不越权代办，维持 open。
