...
- [ ] 3.3 [Owner: Harness Plugins] 同步跨项目文档引用并确认 V1/V2 历史未被改写。Acceptance: 新文档只通过 V3 supersede/link 说明演进，旧 change 内容保持原样。 **[lane: differentiation]** （blocked 2026-08-24: closeout after 3.2.）
