...
- [x] 4.3 更新 `docs/design/dsh-plugin-dev-toolchain-and-experience.md` 附四波收口结论与 14 天 dogfood 观测记录链接。
  - 收口（2026-09-16，窗口 2026-09-01→2026-09-14 已满）：§8 已补窗口末结论——09-14 当日 11 份报告全绿，末报告 temp/toolchain-runs/2026-09-14T201428627Z-toolchain 六检查器零 findings（29/34/974/699/31/10 checked）；全窗 241 份报告偶发红逐项归属并行在途波中途态（CLIENT_NOT_BUILT / SURFACE_REGRESSION 分类前 / RAW_URL・RAW_FETCH 待豁免 / DISPOSE 中途态），均由所属 lane 窗口内清零，无遗留；阻断故障零记录（交互 dogfood 多数会话未观测，如实保留该限制）；窗口后 09-15/09-16 复跑维持全绿（本会话实测 temp/toolchain-runs/2026-09-16T184640914Z-toolchain，六检查器 PASS 零 findings：29/34/994/710/31/10）；W4 行改为 10/10 已收口、四波全部关闭。
  - 进展（2026-09-10，第 10/14 天）：`pnpm run check:plugins` exit 0；六检查器 findings = bundle-contract 27/0、declaration-lint 32/0、safe-projection-audit 743/0、dispose-hmr-conformance 534/0、visual-token-conformance 27/0、personal-coding-contract 10/0；报告 temp/toolchain-runs/2026-09-10T032108077Z-toolchain；阻断故障（白屏/卡死/丢状态）not observed in-session；窗口 2026-09-14 满前如实保持未勾。
  - 进展（2026-09-07，第 7/14 天）：`pnpm run check:plugins` exit 0；六检查器 findings = bundle-contract 27/0、declaration-lint 32/0、safe-projection-audit 657/0、dispose-hmr-conformance 498/0、visual-token-conformance 26/0、personal-coding-contract 10/0；报告 temp/toolchain-runs/2026-09-07T040407631Z-toolchain；阻断故障（白屏/卡死/丢状态）not observed in-session（未交互 dogfood `pnpm dsh:dev`）；窗口 2026-09-14 满前如实保持未勾。
  - 进展（2026-09-06，第 6/14 天）：`pnpm run check:plugins` 复跑 exit 0，六检查器全 PASS 零 findings（报告 temp/toolchain-runs/2026-09-06T164607632Z-toolchain，checked 657/498/26/10 零 findings）；同日全仓 typecheck/build/check:bundles 27/27/check:surfaces/test:visual 92/92 全绿；观测序列续记，无阻断故障；窗口 2026-09-14 满前如实保持未勾。
  - 进展（2026-09-04，第 4/14 天）：`pnpm run check:plugins` 复跑 exit 0，六检查器全 PASS 零 findings（报告 temp/toolchain-runs/2026-09-04T040117865Z-toolchain）；观测序列续记，无阻断故障；窗口 2026-09-14 满前如实保持未勾。
  - 进展（2026-09-03）：§8 已更新至零红灯后状态——W4 行改记「9/10、仅余 4.3 dogfood 窗口」并附 50→16→9→0 清零轨迹与 2026-09-02T151007223Z / 2026-09-03T122937338Z 两份零 findings 报告链接；dogfood 观测行补第 3/14 天状态（零阻断故障、六检查器零 findings）与观测序列。4.1 零红灯前置已达成，唯一余项 = 14 天窗口（2026-09-01 起，2026-09-14 满），窗口未满前不勾、不伪造观测记录，结论以窗口末报告为准。
