...
所有页面与能力均为required：[页面控件设计](../../../docs/design/dsh-scaena-production-studio.md)。遮罩/音乐/字幕等具体模型或provider能力的未验证状态不构成需求删除。第5组tasks补全页面、原型、owner缺口与恢复；第4组closeout必须依赖它们。
