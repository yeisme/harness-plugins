# dsh-ai-drama-client-runtime Specification

## Purpose
Define the additive Drama client runtime, capability probes, registration lifecycle, shared Creator projection consumption, presets, commands, keyboard behavior, and fail-closed context handling.
## Requirements
