# dsh-ai-drama-show-control-client Specification

## Purpose
Define the four accessible show-control panes, bounded paging and selection, and owner-gated episode navigation.
