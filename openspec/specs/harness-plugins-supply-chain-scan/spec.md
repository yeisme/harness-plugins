# harness-plugins-supply-chain-scan Specification

## Purpose
TBD - created by archiving change harness-plugins-osv-security-monitoring-v1. Update Purpose after archive.
## Requirements
