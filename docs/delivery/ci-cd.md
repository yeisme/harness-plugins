# Harness Plugins CI/CD

本项目采用根级 `docs|quick|full|integration|release` 语义，但 workflow、命令和证据由本仓库自己维护。Profile：`pnpm package workspace`。
...
Package publish, docs, upstream canary, and PR rebase remain separate workflows.
