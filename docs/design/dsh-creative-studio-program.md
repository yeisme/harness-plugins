...
| 小说、剧本和文本版本 | split-owner；Auctra | [文本台](../../openspec/changes/archive/2026-09-14-dsh-auctra-writing-studio-v1/design.md) | [Auctra](../../openspec/changes/archive/2026-09-14-dsh-auctra-writing-studio-v1/tasks.md) |
...
| 3D 场景编排、Shot 预演与 glTF/GLB 交换 | fit/split-owner；插件 host 经 storageDomain 保存工作台 scene graph，领域资产、生成与交付仍归 owner | 3D 导演台（独立 surface，可嵌入做剧工作台停靠视口） | [3D 导演台](../../openspec/changes/archive/2026-09-14-dsh-3d-director-gltf-workbench-v1/tasks.md) |
