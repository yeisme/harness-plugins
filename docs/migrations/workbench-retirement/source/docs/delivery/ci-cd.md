# Yeisme Workbench CI/CD

本项目采用根级 `docs|quick|full|integration|release` 语义，但 workflow、命令和证据由本仓库自己维护。Profile：`React/Bun + Go service`。
...
Production/release gates stay manual and evidence-driven; CI does not deploy.
