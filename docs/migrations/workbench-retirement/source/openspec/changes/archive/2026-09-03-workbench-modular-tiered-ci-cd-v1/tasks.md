...
- [x] 1.1 建立或映射 quick/full/integration 场景，保留 existing required check。
...
- [x] 2.3 运行 `openspec validate workbench-modular-tiered-ci-cd-v1 --strict --no-interactive` 和 `git diff --check`。
  - Acceptance: 两条命令返回 0。
