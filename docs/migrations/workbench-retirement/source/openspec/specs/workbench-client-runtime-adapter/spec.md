# workbench-client-runtime-adapter Specification

## Purpose
TBD - created by archiving change workbench-client-runtime-adapter. Update Purpose after archive.
## Requirements
...
- **WHEN** Ordo 或其他获批消费者也消费 `client_runtime.v0.1`
