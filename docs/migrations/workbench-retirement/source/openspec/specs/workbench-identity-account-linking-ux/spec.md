# workbench-identity-account-linking-ux Specification

## Purpose
TBD - created by archiving change workbench-identity-account-linking-ux-v1. Update Purpose after archive.
## Requirements
