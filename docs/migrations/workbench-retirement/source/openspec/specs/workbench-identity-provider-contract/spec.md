# workbench-identity-provider-contract Specification

## Purpose
TBD - created by archiving change workbench-identity-provider-contract-v1. Update Purpose after archive.
## Requirements
