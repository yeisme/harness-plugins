...
if (!beforeRoot) throw new Error('Usage: node scripts/export-pane-keyboard-cycle-patch.mjs <pre-change-source-directory>')
const source = resolve(root, 'temp/dsh-unified-host-source')
const output = resolve(root, 'upstream-prs/pane-keyboard-cycle')
