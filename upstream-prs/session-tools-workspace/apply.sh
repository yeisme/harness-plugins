...
target_dir="${1:?Usage: bash upstream-prs/session-tools-workspace/apply.sh <staging-checkout>}"
...
for file in packages/client/ui-layout/tests/session-tools-title.client.spec.tsx packages/client/ui-conversation/src/client/conversation/navigation.ts packages/client/ui-conversation/tests/session-navigation.client.spec.ts; do
...
echo 'Session Tools workspace patch applied.'
